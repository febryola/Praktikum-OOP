...
Bottle::Bottle() : id(numOfBottle + 1) //ngeset idnya ke 1 karna jumlah botol awal adalah 0   
{
...
{
    float dV = other.getBottleVolume() - other.getWaterVolume();//cari dulu space yg masih ada di botolo lain
    float water = this->getWaterVolume(); //banyak air yg mau dipindahkan
